"use strict"; class ProgressBar {
    constructor(barElem, currentStyle = 'bg-info') { this.barElem = barElem; this.currentStyle = currentStyle; this.isStriped = false; this.isReversed = false; this.barElem.classList.add('progress-fast'); }
    ...
    setAnimation(animation) {
        this.barElem.style.animation = animation; if (this.isReversed)
